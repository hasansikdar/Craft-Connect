...
const PostUserInfo = () => {
    return (
        <div className='flex'>
            <img className='w-10 h-10 rounded-full' src="https://scontent.fdac5-2.fna.fbcdn.net/v/t39.30808-6/318630834_1301786737319944_3904799583444523390_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeFjKxLtWVgY0EcruBuIVQC4QW8Nr8xSuHNBbw2vzFK4c37HruuJsS6Hhy1MU_2h_0URlH6e25P0qxtME-zNc4ri&_nc_ohc=rFDSVULP1gUAX_u9RLZ&_nc_ht=scontent.fdac5-2.fna&oh=00_AfDUyor27xgdIX_rgzNZH6VdvD1Pl-1HDtPeEPny2fepjw&oe=63C2B9A3" alt="" />
            <div className='ml-4'>
