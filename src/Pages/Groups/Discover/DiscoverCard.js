    ...
    return (
        <div className='grid grid-cols-2 gap-5'>
            <div className="card card-compact w-[300px] bg-base-100 shadow-xl">
                <figure><img src={groupimage1} alt="Shoes" /></figure>
            ...
            <div className="card card-compact w-[300px] bg-base-100 shadow-xl">
                <figure><img src={groupimage2} alt="Shoes" /></figure>
                <div className="card-body">
            ...
            <div className="card card-compact w-[300px] bg-base-100 shadow-xl">
                <figure><img src={groupimage3} alt="Shoes" /></figure>
                <div className="card-body">
            ...
            <div className="card card-compact w-[300px] bg-base-100 shadow-xl">
                <figure><img src={groupimage4} alt="Shoes" /></figure>
                <div className="card-body">
            ...
            <div className="card card-compact w-[300px] bg-base-100 shadow-xl">
                <figure><img src={groupimage5} alt="Shoes" /></figure>
                <div className="card-body">
            ...
            <div className="card card-compact w-[300px] bg-base-100 shadow-xl">
                <figure><img src={groupimage6} alt="Shoes" /></figure>
                <div className="card-body">
            ...
            <div className="card card-compact w-[300px] bg-base-100 shadow-xl">
                <figure><img src={groupimage7} alt="Shoes" /></figure>
                <div className="card-body">
