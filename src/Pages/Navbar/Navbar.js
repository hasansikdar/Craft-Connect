      ...
      <div className="dark:bg-[#2C2048] fixed w-full top-0 z-999 h-[72px] ">
        <div className="flex justify-between items-center bg-zinc-800 py-[2px] md:py-0">
          <div className="pl-3">
            <Link
              to="/"
              className="text-2xl text-gray-900 font-semibold flex items-center active"
              href="/"
            >
              {/* <img src={logo} className="w-14 d-block m-auto" alt="" /> */}
              <p className="text-lg text-white ml-1.5 lg:ml-[80px] hidden lg:block">Craft Connect</p>
            </Link>
          </div>
