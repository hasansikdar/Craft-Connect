  ...
  return (
    <>
      <form onSubmit={formSubmit}>
        <div className=" overflow-y-scroll max-h-[250px] bg-gray-100 dark:bg-[#3F3F3F] p-2 rounded mb-2">
          <textarea
            className=" dark:text-white text-black placeholder-text-100 transition-all duration-200 outline-none"
            name="postText"
            rows={5}
        ...
        <div className="mb-2 py-2 px-3 rounded-md flex border items-center justify-between">
          <label className="text-black dark:text-white text-lg font-semibold">
            Add To Your Post{" "}
          </label>
