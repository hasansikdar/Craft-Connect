  ...
  return (
    <div>
      <div className=" dark:bg-black dark:text-white">
        <div className="card-body p-2 flex rounded-lg bg-white  dark:bg-gray-700 dark:text-white shadow-xl w-11/12 m-auto my-5 text-gray-500">
          ...
          <div className="flex items-center flex-col">
            ...
            />
            <h1 className="text-gray-900 font-bold text-xl hidden lg:block">
              Farhan Chowdhury
            </h1>
