...
const Follow = () => {
    return (
        <div className='p-2 py-5 rounded-lg bg-white shadow-xl w-11/12 m-auto my-5 text-gray-500'>
            ...
            <ul className=''>
                <li className='flex items-center justify-between py-3 px-4 hover:bg-gray-100 duration-300 rounded-lg'> 
                    ...
                    <div className='text-center'>
                        <button className='btn btn-sm border-0 bg-inherit hover:bg-sky-500 text-gray-500 hover:text-white rounded'><Link><FaPlus></FaPlus></Link></button>
                    </div>
                </li>
                <li className='flex items-center justify-between py-3 px-4 hover:bg-gray-100 duration-300 rounded-lg'> 
                    <div className="flex items-center">
