...
const Follow = () => {
    return (
        <div className='p-2 py-5 rounded-lg border-zinc-600 shadow-xl w-11/12 m-auto my-5 text-gray-500'>
            <h1 className='text-white ml-4 mb-2'>Follow Now</h1>
            <ul className=''>
                <li className='flex items-center justify-between py-3 px-4 hover:bg-zinc-600 duration-300 rounded-lg'> 
                    ...
                    <div className='text-center'>
                        <button className='text-white btn btn-sm border-0 bg-inherit hover:bg-zinc-500 hover:text-white rounded'><Link><FaPlus></FaPlus></Link></button>
                    </div>
                </li>
                <li className='flex items-center justify-between py-3 px-4 hover:bg-zinc-600 duration-300 rounded-lg'> 
                    <div className="flex items-center">
