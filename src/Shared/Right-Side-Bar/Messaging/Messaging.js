      ...
      <div class="flex h-96 antialiased text-gray-800">
        <div class="flex flex-row h-full w-full overflow-x-hidden">
          <div class="flex flex-col flex-auto h-full">
            <div class="flex flex-col flex-auto flex-shrink-0 h-full p-2">
              <div class="flex flex-col h-full overflow-x-auto mb-4">
                <div class="flex flex-col h-full">
                  <div class="grid grid-cols-12 gap-y-2">
                    <div class="col-start-1 col-end-10 p-1 rounded-lg">
                      <div class="flex flex-row items-center">
                        <div class="flex items-center justify-center h-8 w-8 rounded-full bg-indigo-500 flex-shrink-0">
                          A
                        </div>
                        <div class="relative ml-2 text-sm bg-white py-2 px-4 shadow rounded-xl">
                    ...
                    <div class="col-start-4 col-end-13 p-1 rounded-lg">
                      <div class="flex items-center justify-start flex-row-reverse">
                        ...
                        <div class="relative mr-2 text-sm bg-indigo-100 py-2 px-4 shadow rounded-xl">
