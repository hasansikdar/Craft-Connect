      ...
      <div className="flex h-screen antialiased text-gray-800 w-full">
        <div className="flex flex-row h-full w-full overflow-x-hidden">
          <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-gray-50 flex-shrink-0 w-[20%]">
            ...
            <div className="flex flex-col items-center bg-[#ff505a] text-white border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
              <div className="">
                <img
                  src={user?.photoURL}
                  alt="photoURL"
            ...
            <div className="bg-white mt-5 p-2 rounded-md">
              <div className="flex flex-col">
                ...
                <div className="flex flex-col space-y-1 mt-4 -mx-2 h-80 overflow-y-auto">
                  <div className="px-2">
                    <button
                      className="flex flex-row items-center hover:bg-[#ff505a] hover:text-white rounded-xl p-2 w-full active"
                      onClick={() => setCurrentfrnd(allusers)}
                    >
